...
contract LockRedeem_Kratos {
    ...
    modifier onlyValidator() {
        ...
        _;
        // Continues control flow after this is validates
    }



    constructor(address[] memory initialValidators, uint _lock_period, address _old_contract, uint noofValidatorsinold) public {
    ...
    function ActiveStatus() public view returns (bool) {
        return ACTIVE;
    }

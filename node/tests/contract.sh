...
echo "=================== Test Contracts =================="
olclient install --root $OLDATA/David-Node --owner David-OneLedger --name Test --version v0.0.1 -f $TESTS/helloworld.js --fee 0.09
...
olclient execute --root $OLDATA/David-Node --owner David-OneLedger --name Test --version v0.0.1 --fee 0.001 --gas 0.10

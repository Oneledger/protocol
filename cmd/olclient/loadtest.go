...
func init() {
	...
	loadtestCmd.Flags().StringVar(&loadTestArgs.rpcAddress, "rpcAddress", "tcp://127.0.0.1:38604", "rpc endpoint which will be used")
	loadtestCmd.Flags().StringVar(&loadTestArgs.sdkAddress, "sdkAddress", "http://127.0.0.1:38606", "sdk endpoint which will be used")
}
...
func getContext(RPCAddress string, SDKAddress string) *Context {
	ctx := &Context{

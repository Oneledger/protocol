...
func init() {
	...
	testnetCmd.Flags().Int64Var(&testnetArgs.minVotesRequired, "min_votes", 800, "Set Min votes for evidence")
	testnetCmd.Flags().Int64Var(&testnetArgs.blockVotesDiff, "block_diff", 1000, "Set block Votes diff evidence")

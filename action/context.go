...
func NewContext(r Router, header *abci.Header, state *storage.State,
	...
	lockScriptStore *bitcoin.LockScriptStore, proposals *governance.ProposalStore,
	propFunds *governance.ProposalFundStore, logger *log.Logger) *Context {

...
const (
	...
	WITHDRAW_NETWORK_DELEGATION       Type = 0x55
	REWARDS_REINVEST_NETWORK_DELEGATE Type = 0x56
...
func init() {
	...
	RegisterTxType(WITHDRAW_NETWORK_DELEGATION, "WITHDRAW_NETWORK_DELEGATION")
